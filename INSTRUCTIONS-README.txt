PINN INSTALLATION INSTRUCTIONS
...
3. Extract the files contained in this PINN zip file.
...
Your Pi will now boot into PINN and should display a list of operating systems that you can choose to install.
